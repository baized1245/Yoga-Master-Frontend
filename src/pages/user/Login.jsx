  ...
  return (
    <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <p className="mx-auto mt-4 max-w-md text-center text-gray-500">
        Explore our comrehensive library of courses, meticulously crafted to all
        levels of experties.
      </p>
      ...
      <div className="mx-auto max-w-lg mb-0 mt-6 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full border outline-none rounded-lg border-gray-200 p-4 pe-12"
                id=""
              />
          ...
          <button
            type="submit"
            className="block w-full rounded-lg bg-secondary px-5 py-3 text-sm font-medium text-white hover:opacity-80"
          >
            Sign in
          </button>
